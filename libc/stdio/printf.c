...
/* Based on https://wiki.osdev.org/User:A22347/Printf */

char* __int_str(int32_t i, char b[], int base, bool plusSignIfNeeded, bool spaceSignIfNeeded,
        ...
        if (format[i] == '%') {
            ...
            switch (specifier) {
                ...
                case 'G':
                {
                    ...
                    int32_t decPlaces = (int32_t) (floating + 0.5);
